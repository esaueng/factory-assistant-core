...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:  # noqa: C901
    ...
    async def _async_service_program(call: ServiceCall, start: bool) -> None:
        ...
        async_create_issue(
            ...
            REDACTED_VALUE"deprecated_set_program_and_option_actions",
            translation_placeholders={
        ...
        try:
            ...
            raise HomeAssistantError(
                translation_domain=DOMAIN,
                REDACTED_VALUE"start_program" if start else "select_program",
                translation_placeholders={
    ...
    async def _async_service_set_program_options(
        ...
        try:
            ...
            raise HomeAssistantError(
                translation_domain=DOMAIN,
                REDACTED_VALUE"set_options_active_program"
                if active
    ...
    async def _async_service_command(
        ...
        async_create_issue(
            ...
            is_persistent=True,
            severity=IssueSeverity.WARNING,
            REDACTED_VALUE"deprecated_command_actions",
        )

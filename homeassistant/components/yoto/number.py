...
NUMBERS: tuple[YotoNumberEntityDescription, ...] = (
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"day_max_volume_limit",
        native_min_value=0,
        native_max_value=16,
        native_step=1,
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"night_max_volume_limit",
        native_min_value=0,
        native_max_value=16,
        native_step=1,
        entity_category=EntityCategory.CONFIG,
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"day_display_brightness",
        native_min_value=0,
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"night_display_brightness",
        native_min_value=0,
        native_max_value=100,
        native_step=1,
        native_unit_of_measurement=PERCENTAGE,
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"display_dim_brightness",
        native_min_value=0,
        native_max_value=100,
        native_step=1,
        native_unit_of_measurement=PERCENTAGE,
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"shutdown_timeout",
    ...
    YotoNumberEntityDescription(
        ...
        REDACTED_VALUE"display_dim_timeout",
        device_class=NumberDeviceClass.DURATION,
        native_min_value=0,

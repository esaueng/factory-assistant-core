...
SWITCHES: tuple[YotoSwitchEntityDescription, ...] = (
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"bluetooth_headphones",
        entity_category=EntityCategory.CONFIG,
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"headphones_volume_limit",
        entity_category=EntityCategory.CONFIG,
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"pause_volume_down",
        entity_category=EntityCategory.CONFIG,
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"pause_power_button",
        entity_category=EntityCategory.CONFIG,
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"day_auto_brightness",
        entity_category=EntityCategory.CONFIG,
    ...
    YotoSwitchEntityDescription(
        ...
        REDACTED_VALUE"night_auto_brightness",
        entity_category=EntityCategory.CONFIG,

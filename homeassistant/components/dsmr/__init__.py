...
def async_migrate_entity_entry(
    ...
    for old, new in (
        ...
        ("Voltage_Sags_Phase_L1", "REDACTED_VALUE"),
        ("Voltage_Sags_Phase_L2", "REDACTED_VALUE"),
        ("Voltage_Sags_Phase_L3", "REDACTED_VALUE"),
        ("Voltage_Swells_Phase_L1", "REDACTED_VALUE"),
        ("Voltage_Swells_Phase_L2", "REDACTED_VALUE"),
        ("Voltage_Swells_Phase_L3", "REDACTED_VALUE"),

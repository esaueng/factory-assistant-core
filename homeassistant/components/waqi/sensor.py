...
async def async_setup_platform(
    ...
    try:
        ...
        async_create_issue(
            ...
            REDACTED_VALUE"deprecated_yaml_import_issue_invalid_auth",
        ...
        async_create_issue(
            ...
            issue_domain=DOMAIN,
            severity=IssueSeverity.WARNING,
            REDACTED_VALUE"deprecated_yaml_import_issue_cannot_connect",
            translation_placeholders=ISSUE_PLACEHOLDER,
        )
    ...
    if station_count == 0:
        async_create_issue(
            ...
            issue_domain=DOMAIN,
            severity=IssueSeverity.WARNING,
            REDACTED_VALUE"deprecated_yaml_import_issue_none_found",
            translation_placeholders=ISSUE_PLACEHOLDER,
        )
...
SENSORS: list[WAQISensorEntityDescription] = [
    ...
    WAQISensorEntityDescription(
        ...
        REDACTED_VALUE"dominant_pollutant",

...
FITBIT_RESOURCES_LIST = {
    ...
    "REDACTED_VALUE": ["Calories BMR", "cal", "fire"],
    ...
    "REDACTED_VALUE": ["Awakenings Count", "times awaken", "sleep"],
    "sleep/efficiency": ["Sleep Efficiency", "%", "sleep"],
    "REDACTED_VALUE": ["Minutes After Wakeup", "minutes", "sleep"],
    "sleep/minutesAsleep": ["Sleep Minutes Asleep", "minutes", "sleep"],
    "REDACTED_VALUE": ["Sleep Minutes Awake", "minutes", "sleep"],
    "REDACTED_VALUE": ["Sleep Minutes to Fall Asleep", "minutes", "sleep"],

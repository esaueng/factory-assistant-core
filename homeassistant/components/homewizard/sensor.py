...
SENSORS: Final[tuple[HomeWizardSensorEntityDescription, ...]] = (
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_import_t1_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda data: (
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_import_t2_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_import_t3_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_import_t4_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_export_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_export_t1_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        has_fn=lambda data: (
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_export_t2_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_export_t3_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_energy_export_t4_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
...
EXTERNAL_SENSORS = {
    ...
    ExternalDevice.DeviceType.HEAT_METER: HomeWizardExternalSensorEntityDescription(
        key="heat_meter",
        REDACTED_VALUE"total_energy_gj",

...
SENSORS: Final[tuple[HomeWizardSensorEntityDescription, ...]] = (
    ...
    HomeWizardSensorEntityDescription(
        key="unique_meter_id",
        REDACTED_VALUE"unique_meter_id",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_import_kwh",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_import_t1_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_import_t2_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_import_t3_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_import_t4_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_export_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_export_t1_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_export_t2_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_export_t3_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"total_power_export_t4_kwh",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_power_l1_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_power_l2_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_power_l3_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_voltage_l1_v",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_voltage_l2_v",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_voltage_l3_v",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_current_l1_a",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_current_l2_a",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_current_l3_a",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        entity_registry_enabled_default=False,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_frequency_hz",
    ...
    HomeWizardSensorEntityDescription(
        ...
        icon="mdi:alert",
        entity_category=EntityCategory.DIAGNOSTIC,
        has_fn=lambda data: data.REDACTED_VALUE is not None,
        value_fn=lambda data: data.REDACTED_VALUE,
    ),
    HomeWizardSensorEntityDescription(
        key="REDACTED_VALUE",
        REDACTED_VALUE"REDACTED_VALUE",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"any_power_fail_count",
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"long_power_fail_count",
        icon="mdi:transmission-tower-off",
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_power_average_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"monthly_power_peak_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
    ...
    HomeWizardSensorEntityDescription(
        ...
        REDACTED_VALUE"active_liter_lpm",

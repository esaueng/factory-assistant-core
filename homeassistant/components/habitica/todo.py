...
class BaseHabiticaListEntity(
        ...
        for task_id in uids:
            try:
                ...
                raise ServiceValidationError(
                    ...
                    REDACTED_VALUEf"delete_{self.idx}_failed",
                ) from e
    ...
    async def async_move_todo_item(
        ...
        try:
            ...
            raise ServiceValidationError(
                translation_domain=DOMAIN,
                REDACTED_VALUEf"move_{self.idx}_item_failed",
    ...
    async def async_update_todo_item(self, item: TodoItem) -> None:
        ...
        try:
            ...
            raise ServiceValidationError(
                translation_domain=DOMAIN,
                REDACTED_VALUEf"update_{self.idx}_item_failed",
        ...
        try:
            ...
            raise ServiceValidationError(
                translation_domain=DOMAIN,
                REDACTED_VALUEf"score_{self.idx}_item_failed",
                translation_placeholders={"name": item.summary or ""},
            ) from e
...
class HabiticaTodosListEntity(BaseHabiticaListEntity):
    ...
    async def async_create_todo_item(self, item: TodoItem) -> None:
        ...
        try:
            ...
            raise ServiceValidationError(
                translation_domain=DOMAIN,
                REDACTED_VALUEf"create_{self.idx}_item_failed",
                translation_placeholders={"name": item.summary or ""},
            ) from e

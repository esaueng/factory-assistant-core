...
BINARY_SENSORS = [
    ...
    StarlinkBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"thermal_throttle",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    StarlinkBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"unexpected_location",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,

...
SENSORS: tuple[MadvrSensorEntityDescription, ...] = (
    ...
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEINCOMING_BIT_DEPTH,
        device_class=SensorDeviceClass.ENUM,
    ...
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEINCOMING_COLORIMETRY,
        device_class=SensorDeviceClass.ENUM,
    ...
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEINCOMING_BLACK_LEVELS,
        device_class=SensorDeviceClass.ENUM,
        options=["TV", "PC"],
    ),
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEINCOMING_ASPECT_RATIO,
        device_class=SensorDeviceClass.ENUM,
        options=["16:9", "4:3"],
        entity_registry_enabled_default=False,
    ),
    ...
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEOUTGOING_BIT_DEPTH,
        device_class=SensorDeviceClass.ENUM,
        options=["8bit", "10bit", "12bit"],
    ),
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEOUTGOING_COLORIMETRY,
        device_class=SensorDeviceClass.ENUM,
        options=["SDR", "HDR10", "HLG 601", "PAL", "709", "DCI", "2020"],
    ),
    MadvrSensorEntityDescription(
        ...
        REDACTED_VALUEOUTGOING_BLACK_LEVELS,
        device_class=SensorDeviceClass.ENUM,
        options=["TV", "PC"],
    ),
    MadvrSensorEntityDescription(

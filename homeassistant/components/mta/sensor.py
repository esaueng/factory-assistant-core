...
SENSOR_DESCRIPTIONS: tuple[MTASensorEntityDescription, ...] = (
    ...
    MTASensorEntityDescription(
        ...
        REDACTED_VALUE"second_arrival_route",
        arrival_index=1,
        value_fn=lambda arrival: arrival.route_id,
    ),
    MTASensorEntityDescription(
        key="second_arrival_destination",
        REDACTED_VALUE"second_arrival_destination",
        arrival_index=1,
        value_fn=lambda arrival: arrival.destination,
    ),
    MTASensorEntityDescription(
        key="third_arrival",
        REDACTED_VALUE"third_arrival",
        device_class=SensorDeviceClass.TIMESTAMP,
        arrival_index=2,
        value_fn=lambda arrival: arrival.arrival_time,
    ),
    MTASensorEntityDescription(
        ...
        REDACTED_VALUE"third_arrival_route",
        arrival_index=2,
        value_fn=lambda arrival: arrival.route_id,
    ),
    MTASensorEntityDescription(
        key="third_arrival_destination",
        REDACTED_VALUE"third_arrival_destination",
        arrival_index=2,
        value_fn=lambda arrival: arrival.destination,
    ),
)

...
FAULT_TYPES = [
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_battery_mising",
        entity_registry_enabled_default=True,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_ac_fail",
        entity_registry_enabled_default=True,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_phone_line_failure",
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_parameter_crc_fail_in_pif",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_communication_fail_since_rps_hang_up",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_sdi_fail_since_rps_hang_up",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_user_code_tamper_since_rps_hang_up",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_fail_to_call_rps_since_rps_hang_up",
        entity_registry_enabled_default=False,
        fault=ALARM_PANEL_FAULTS.FAIL_TO_CALL_RPS_SINCE_RPS_HANG_UP,
    ),
    BoschAlarmFaultEntityDescription(
        key="panel_fault_point_bus_fail_since_rps_hang_up",
        REDACTED_VALUE"panel_fault_point_bus_fail_since_rps_hang_up",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_log_overflow",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,
    ...
    BoschAlarmFaultEntityDescription(
        ...
        REDACTED_VALUE"panel_fault_log_threshold",
        entity_registry_enabled_default=False,
        device_class=BinarySensorDeviceClass.PROBLEM,

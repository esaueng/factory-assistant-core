...
SENSOR_TYPES = {
    ...
    'REDACTED_VALUE': ['Wind direction azimuth 1d', '°',
                       'mdi:compass-outline'],
    'REDACTED_VALUE': ['Wind direction azimuth 2d', '°',
                       'mdi:compass-outline'],
    'REDACTED_VALUE': ['Wind direction azimuth 3d', '°',
                       'mdi:compass-outline'],
    'REDACTED_VALUE': ['Wind direction azimuth 4d', '°',
                       'mdi:compass-outline'],
    'REDACTED_VALUE': ['Wind direction azimuth 5d', '°',
                       'mdi:compass-outline'],

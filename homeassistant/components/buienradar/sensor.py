...
SENSOR_TYPES = {
    ...
    "REDACTED_VALUE": ["Wind direction azimuth 1d", UNIT_DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 2d", UNIT_DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 3d", UNIT_DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 4d", UNIT_DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 5d", UNIT_DEGREE, "mdi:compass-outline"],

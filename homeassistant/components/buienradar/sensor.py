...
SENSOR_TYPES = {
    ...
    "REDACTED_VALUE": ["Wind direction azimuth 1d", DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 2d", DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 3d", DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 4d", DEGREE, "mdi:compass-outline"],
    "REDACTED_VALUE": ["Wind direction azimuth 5d", DEGREE, "mdi:compass-outline"],

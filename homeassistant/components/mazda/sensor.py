...
SENSOR_ENTITIES = [
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"fuel_remaining_percentage",
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"fuel_distance_remaining",
        icon="mdi:gas-station",
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"front_left_tire_pressure",
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"front_right_tire_pressure",
        icon="mdi:car-tire-alert",
        device_class=SensorDeviceClass.PRESSURE,
        native_unit_of_measurement=UnitOfPressure.PSI,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"rear_left_tire_pressure",
        icon="mdi:car-tire-alert",
        device_class=SensorDeviceClass.PRESSURE,
        native_unit_of_measurement=UnitOfPressure.PSI,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"rear_right_tire_pressure",
        icon="mdi:car-tire-alert",
        device_class=SensorDeviceClass.PRESSURE,
        native_unit_of_measurement=UnitOfPressure.PSI,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    MazdaSensorEntityDescription(
        key="ev_charge_level",
        REDACTED_VALUE"ev_charge_level",
    ...
    MazdaSensorEntityDescription(
        ...
        REDACTED_VALUE"ev_remaining_range",
        icon="mdi:ev-station",
        device_class=SensorDeviceClass.DISTANCE,
        native_unit_of_measurement=UnitOfLength.KILOMETERS,
        state_class=SensorStateClass.MEASUREMENT,

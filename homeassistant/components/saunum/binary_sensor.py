...
BINARY_SENSORS: tuple[LeilSaunaBinarySensorEntityDescription, ...] = (
    ...
    LeilSaunaBinarySensorEntityDescription(
        key="alarm_door_open",
        REDACTED_VALUE"alarm_door_open",
    ...
    LeilSaunaBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"alarm_door_sensor",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    LeilSaunaBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"alarm_thermal_cutoff",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    LeilSaunaBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"alarm_internal_temp",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    LeilSaunaBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"alarm_temp_sensor_short",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    LeilSaunaBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"alarm_temp_sensor_open",
        device_class=BinarySensorDeviceClass.PROBLEM,
        entity_category=EntityCategory.DIAGNOSTIC,

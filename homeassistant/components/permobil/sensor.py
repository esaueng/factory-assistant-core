...
SENSOR_DESCRIPTIONS: tuple[PermobilSensorEntityDescription, ...] = (
    ...
    PermobilSensorEntityDescription(
        ...
        key="state_of_health",
        REDACTED_VALUE"state_of_health",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    PermobilSensorEntityDescription(
        ...
        REDACTED_VALUE"charge_time_left",
    ...
    PermobilSensorEntityDescription(
        ...
        REDACTED_VALUE"indoor_drive_time",
        native_unit_of_measurement=UnitOfTime.HOURS,
        device_class=SensorDeviceClass.DURATION,
    ),
    PermobilSensorEntityDescription(
    ...
    PermobilSensorEntityDescription(
        ...
        * BATTERY_ASSUMED_VOLTAGE,
        ...
        key="watt_hours_left",
        REDACTED_VALUE"watt_hours_left",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY_STORAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    PermobilSensorEntityDescription(
        ...
        REDACTED_VALUE"max_distance_left",
        native_unit_of_measurement=UnitOfLength.KILOMETERS,
        device_class=SensorDeviceClass.DISTANCE,
    ),
    PermobilSensorEntityDescription(
    ...
    PermobilSensorEntityDescription(
        ...
        REDACTED_VALUE"usage_adjustments",
    ...
    PermobilSensorEntityDescription(
        ...
        REDACTED_VALUE"record_adjustments",
        native_unit_of_measurement="adjustments",
        state_class=SensorStateClass.TOTAL_INCREASING,
    ),
    PermobilSensorEntityDescription(
        ...
        key="record_distance",
        REDACTED_VALUE"record_distance",
        device_class=SensorDeviceClass.DISTANCE,
        state_class=SensorStateClass.TOTAL_INCREASING,
    ),
)

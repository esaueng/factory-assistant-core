...
SENSORS: tuple[NextDnsSensorEntityDescription, ...] = (
    ...
    NextDnsSensorEntityDescription[AnalyticsStatus](
        ...
        coordinator_type=ATTR_STATUS,
        entity_category=EntityCategory.DIAGNOSTIC,
        REDACTED_VALUE"blocked_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsStatus](
        ...
        coordinator_type=ATTR_STATUS,
        entity_category=EntityCategory.DIAGNOSTIC,
        REDACTED_VALUE"relayed_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsStatus](
        ...
        coordinator_type=ATTR_STATUS,
        entity_category=EntityCategory.DIAGNOSTIC,
        REDACTED_VALUE"blocked_queries_ratio",
    ...
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.DIAGNOSTIC,
        REDACTED_VALUE"doh_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        value=lambda data: data.REDACTED_VALUE,
    ),
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"dot_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.DIAGNOSTIC,
        REDACTED_VALUE"doq_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"tcp_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsProtocols](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"udp_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsEncryption](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"encrypted_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsEncryption](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"unencrypted_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsEncryption](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"encrypted_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NextDnsSensorEntityDescription[AnalyticsDnssec](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"validated_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsDnssec](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"not_validated_queries",
        state_class=SensorStateClass.TOTAL,
    ...
    NextDnsSensorEntityDescription[AnalyticsDnssec](
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        REDACTED_VALUE"validated_queries_ratio",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,

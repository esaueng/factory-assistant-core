...
SENSORS: tuple[NAMSensorEntityDescription, ...] = (
    NAMSensorEntityDescription(
        ...
        value=lambda sensors: sensors.REDACTED_VALUE,
    ),
    NAMSensorEntityDescription(
        key=ATTR_BME280_PRESSURE,
        REDACTED_VALUE"bme280_pressure",
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"bme280_temperature",
        suggested_display_precision=1,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"bmp180_pressure",
        suggested_display_precision=0,
        native_unit_of_measurement=UnitOfPressure.HPA,
        device_class=SensorDeviceClass.PRESSURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"bmp180_temperature",
        suggested_display_precision=1,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"bmp280_pressure",
        suggested_display_precision=0,
        native_unit_of_measurement=UnitOfPressure.HPA,
        device_class=SensorDeviceClass.PRESSURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"bmp280_temperature",
        suggested_display_precision=1,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"heca_temperature",
        suggested_display_precision=1,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"sht3x_temperature",
        suggested_display_precision=1,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    NAMSensorEntityDescription(
        ...
        REDACTED_VALUE"dht22_temperature",
        suggested_display_precision=1,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,

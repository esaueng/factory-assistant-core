...
BINARY_SENSOR_DESCRIPTIONS: tuple[VistapoolBinarySensorEntityDescription, ...] = (
    VistapoolBinarySensorEntityDescription(
        key="filtration",
        REDACTED_VALUE"filtration",
        device_class=BinarySensorDeviceClass.RUNNING,
        value_path="filtration.status",
    ),
    VistapoolBinarySensorEntityDescription(
        key="backwash",
        REDACTED_VALUE"backwash",
        device_class=BinarySensorDeviceClass.RUNNING,
    ...
    VistapoolBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"hidro_cover_reduction",
        device_class=BinarySensorDeviceClass.RUNNING,
    ...
    VistapoolBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"conductivity_module",
    ...
    VistapoolBinarySensorEntityDescription(
        key="chlorine_module",
        REDACTED_VALUE"chlorine_module",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,

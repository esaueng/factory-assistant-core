...
SPEED_SENSORS: tuple[SensorEntityDescription, ...] = (
    SensorEntityDescription(key="download", REDACTED_VALUE"download_speed"),
    SensorEntityDescription(key="upload", REDACTED_VALUE"upload_speed"),
)

STATUS_SENSORS: tuple[SensorEntityDescription, ...] = (
    SensorEntityDescription(key="status", REDACTED_VALUE"transmission_status"),
)

TORRENT_SENSORS: tuple[SensorEntityDescription, ...] = (
    SensorEntityDescription(key="active_torrents", REDACTED_VALUE"active_torrents"),
    SensorEntityDescription(key="paused_torrents", REDACTED_VALUE"paused_torrents"),
    SensorEntityDescription(key="total_torrents", REDACTED_VALUE"total_torrents"),
    SensorEntityDescription(
        key="completed_torrents", REDACTED_VALUE"completed_torrents"
    ),
    SensorEntityDescription(key="started_torrents", REDACTED_VALUE"started_torrents"),
)

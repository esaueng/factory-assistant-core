...
SENSOR_TYPES = (
    ...
    RfxtrxSensorEntityDescription(
        key="Energy usage",
        REDACTED_VALUE"instantaneous_power",
    ...
    RfxtrxSensorEntityDescription(
        key="Total usage",
        REDACTED_VALUE"total_energy_usage",
    ...
    RfxtrxSensorEntityDescription(
        ...
        REDACTED_VALUE"wind_average_speed",
        state_class=SensorStateClass.MEASUREMENT,
    ...
    RfxtrxSensorEntityDescription(
        key="Forecast",
        REDACTED_VALUE"forecast_status",
    ),
    RfxtrxSensorEntityDescription(
        key="Forecast numeric",
        REDACTED_VALUE"forecast",
    ),
    RfxtrxSensorEntityDescription(
        key="Humidity status",
        REDACTED_VALUE"humidity_status",
    ),
    RfxtrxSensorEntityDescription(
        key="UV",

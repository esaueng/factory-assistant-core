...
SWITCH_DESCRIPTIONS: list[FoscamSwitchEntityDescription] = [
    ...
    FoscamSwitchEntityDescription(
        ...
        REDACTED_VALUE"white_light_switch",
    ...
    FoscamSwitchEntityDescription(
        key="is_siren_alarm",
        REDACTED_VALUE"siren_alarm_switch",
    ...
    FoscamSwitchEntityDescription(
        ...
        REDACTED_VALUE"turn_off_volume_switch",
    ...
    FoscamSwitchEntityDescription(
        ...
        REDACTED_VALUE"turn_off_light_switch",
    ...
    FoscamSwitchEntityDescription(
        key="human_detection",
        REDACTED_VALUE"human_detection",

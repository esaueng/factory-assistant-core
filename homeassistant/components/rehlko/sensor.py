...
SENSORS: tuple[RehlkoSensorEntityDescription, ...] = (
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"engine_oil_pressure",
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"engine_coolant_temperature",
    ...
    RehlkoSensorEntityDescription(
        key="lubeOilTempF",
        REDACTED_VALUE"lube_oil_temperature",
        native_unit_of_measurement=UnitOfTemperature.FAHRENHEIT,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    RehlkoSensorEntityDescription(
        key="controllerTempF",
        REDACTED_VALUE"controller_temperature",
        native_unit_of_measurement=UnitOfTemperature.FAHRENHEIT,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"engine_compartment_temperature",
        native_unit_of_measurement=UnitOfTemperature.FAHRENHEIT,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"engine_frequency",
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"total_operation",
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"runtime_since_last_maintenance",
        device_class=SensorDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.HOURS,
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
    ...
    RehlkoSensorEntityDescription(
        key="deviceIpAddress",
        REDACTED_VALUE"device_ip_address",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        document_key=GENERATOR_DATA_DEVICE,
    ),
    RehlkoSensorEntityDescription(
        key="serverIpAddress",
        REDACTED_VALUE"server_ip_address",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    RehlkoSensorEntityDescription(
        key="utilityVoltageV",
        REDACTED_VALUE"utility_voltage",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"generator_voltage_avg",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"generator_load_percent",
    ...
    RehlkoSensorEntityDescription(
        ...
        REDACTED_VALUE"next_maintainance",
        device_class=SensorDeviceClass.TIMESTAMP,
        document_key=GENERATOR_DATA_DEVICE,
        value_fn=datetime.fromisoformat,
        entity_registry_enabled_default=False,

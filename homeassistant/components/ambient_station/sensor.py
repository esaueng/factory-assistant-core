...
SENSOR_DESCRIPTIONS = (
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"REDACTED_VALUEn",
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"pm10_indoor_aqin",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"co2_indoor_aqin",
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"co2_indoor_24h_aqin",
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_MILLION,
        device_class=SensorDeviceClass.CO2,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        ...
        REDACTED_VALUE"pm_indoor_temp_aqin",
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"pm_indoor_humidity_aqin",
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"pm25_aqi_aqin",
        device_class=SensorDeviceClass.AQI,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_AQI_PM25_24H_AQIN,
        REDACTED_VALUE"pm25_aqi_24h_aqin",
        device_class=SensorDeviceClass.AQI,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_AQI_PM10_AQIN,
        REDACTED_VALUE"pm10_aqi_aqin",
        device_class=SensorDeviceClass.AQI,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_AQI_PM10_24H_AQIN,
        REDACTED_VALUE"pm10_aqi_24h_aqin",
        device_class=SensorDeviceClass.AQI,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
    ...
    SensorEntityDescription(
        key=TYPE_HUMIDITYIN,
        REDACTED_VALUE"humidity_indoor",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUE"last_lightning_strike",
        device_class=SensorDeviceClass.TIMESTAMP,
    ),
    SensorEntityDescription(
        key=TYPE_LASTLIGHTNING_DISTANCE,
        REDACTED_VALUE"last_lightning_strike_distance",
    ...
    SensorEntityDescription(
        key=TYPE_SOILHUM1,
        REDACTED_VALUE"soil_humidity_1",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM2,
        REDACTED_VALUE"soil_humidity_2",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM3,
        REDACTED_VALUE"soil_humidity_3",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM4,
        REDACTED_VALUE"soil_humidity_4",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM5,
        REDACTED_VALUE"soil_humidity_5",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM6,
        REDACTED_VALUE"soil_humidity_6",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM7,
        REDACTED_VALUE"soil_humidity_7",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM8,
        REDACTED_VALUE"soil_humidity_8",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=TYPE_SOILHUM9,
        REDACTED_VALUE"soil_humidity_9",
        native_unit_of_measurement=PERCENTAGE,
        device_class=SensorDeviceClass.HUMIDITY,
        state_class=SensorStateClass.MEASUREMENT,
    ),

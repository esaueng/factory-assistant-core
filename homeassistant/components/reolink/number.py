...
NUMBER_ENTITIES = (
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetWhiteLed",
        cmd_id=[289, 438],
        REDACTED_VALUE"floodlight_brightness",
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetWhiteLed",
        cmd_id=[289, 438],
        REDACTED_VALUE"floodlight_event_brightness",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetWhiteLed",
        cmd_id=[289, 438],
        REDACTED_VALUE"floodlight_event_on_time",
        entity_category=EntityCategory.CONFIG,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetWhiteLed",
        cmd_id=[289, 438],
        REDACTED_VALUE"floodlight_event_flash_time",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        key="volume_doorbell",
        cmd_key="GetAudioCfg",
        REDACTED_VALUE"volume_doorbell",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="439",
        REDACTED_VALUE"audio_noise_reduction",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetPtzGuard",
        REDACTED_VALUE"guard_return_time",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        native_step=1,
        native_unit_of_measurement=UnitOfTime.SECONDS,
    ...
    ReolinkNumberEntityDescription(
        key="pir_sensitivity",
        cmd_key="GetPirInfo",
        REDACTED_VALUE"pir_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=1,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_face_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_person_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_vehicle_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_non_motor_vehicle_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_package_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_pet_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        key="ai_pet_sensititvity",
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_animal_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
        native_max_value=100,
    ...
    ReolinkNumberEntityDescription(
        key="cry_sensitivity",
        cmd_key="299",
        REDACTED_VALUE"cry_sensitivity",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=1,
        native_max_value=5,
    ...
    ReolinkNumberEntityDescription(
        key="ai_person_delay",
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_person_delay",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_non_motor_vehicle_delay",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_vehicle_delay",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_package_delay",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        key="ai_pet_delay",
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_animal_delay",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        REDACTED_VALUE"auto_quick_reply_time",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        native_step=1,
        native_unit_of_measurement=UnitOfTime.SECONDS,
    ...
    ReolinkNumberEntityDescription(
        ...
        REDACTED_VALUE"auto_track_limit_left",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=-1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetPtzTraceSection",
        REDACTED_VALUE"auto_track_limit_right",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=-1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiCfg",
        REDACTED_VALUE"auto_track_disappear_time",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiCfg",
        REDACTED_VALUE"auto_track_stop_time",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        entity_registry_enabled_default=False,
        native_step=1,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetIsp",
        REDACTED_VALUE"day_night_switch_threshold",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetImage",
        cmd_id=[26, 78],
        REDACTED_VALUE"image_brightness",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetImage",
        cmd_id=[26, 78],
        REDACTED_VALUE"image_saturation",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetImage",
        cmd_id=[26, 78],
        REDACTED_VALUE"image_sharpness",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        key="pre_record_time",
        cmd_key="594",
        REDACTED_VALUE"pre_record_time",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=2,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="594",
        REDACTED_VALUE"pre_record_battery_stop",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=10,
...
SMART_AI_NUMBER_ENTITIES = (
    ReolinkSmartAINumberEntityDescription(
        ...
        cmd_id=527,
        REDACTED_VALUE"crossline_sensitivity",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        cmd_id=529,
        REDACTED_VALUE"intrusion_sensitivity",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        cmd_id=531,
        REDACTED_VALUE"linger_sensitivity",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        smart_type="legacy",
        cmd_id=549,
        REDACTED_VALUE"forgotten_item_sensitivity",
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        smart_type="loss",
        cmd_id=551,
        REDACTED_VALUE"taken_item_sensitivity",
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        smart_type="intrusion",
        cmd_id=529,
        REDACTED_VALUE"intrusion_delay",
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        native_step=1,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        smart_type="legacy",
        cmd_id=549,
        REDACTED_VALUE"forgotten_item_delay",
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        native_step=1,
    ...
    ReolinkSmartAINumberEntityDescription(
        ...
        smart_type="loss",
        cmd_id=551,
        REDACTED_VALUE"taken_item_delay",
        entity_registry_enabled_default=False,
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.DURATION,
        native_step=1,

...
NUMBER_ENTITIES = (
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_face_sensititvity",
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_person_sensititvity",
        icon="mdi:account",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_vehicle_sensititvity",
        icon="mdi:car",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_package_sensititvity",
    ...
    ReolinkNumberEntityDescription(
        ...
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_pet_sensititvity",
        icon="mdi:dog-side",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,
    ...
    ReolinkNumberEntityDescription(
        key="ai_pet_sensititvity",
        cmd_key="GetAiAlarm",
        REDACTED_VALUE"ai_animal_sensititvity",
        icon="mdi:paw",
        entity_category=EntityCategory.CONFIG,
        native_step=1,
        native_min_value=0,

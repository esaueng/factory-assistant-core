...
STOP_SENSOR_DESCRIPTIONS: tuple[DataGrandLyonStopSensorEntityDescription, ...] = (
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_1",
    ...
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_1_direction",
        departure_index=0,
        value_fn=lambda p: p.direction,
    ),
    DataGrandLyonStopSensorEntityDescription(
        key="next_departure_1_type",
        REDACTED_VALUE"next_departure_1_type",
    ...
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_2",
        device_class=SensorDeviceClass.TIMESTAMP,
        departure_index=1,
        value_fn=_departure_time,
    ),
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_2_direction",
        departure_index=1,
        value_fn=lambda p: p.direction,
    ...
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_2_type",
        device_class=SensorDeviceClass.ENUM,
        options=_DEPARTURE_TYPE_OPTIONS,
        departure_index=1,
        value_fn=lambda p: p.type.name.lower(),
    ...
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_3",
        device_class=SensorDeviceClass.TIMESTAMP,
        departure_index=2,
        value_fn=_departure_time,
    ),
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_3_direction",
        departure_index=2,
        value_fn=lambda p: p.direction,
        entity_registry_enabled_default=False,
    ),
    DataGrandLyonStopSensorEntityDescription(
        ...
        REDACTED_VALUE"next_departure_3_type",
        device_class=SensorDeviceClass.ENUM,
        options=_DEPARTURE_TYPE_OPTIONS,
        departure_index=2,
        value_fn=lambda p: p.type.name.lower(),

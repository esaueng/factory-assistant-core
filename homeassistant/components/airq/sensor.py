...
SENSOR_TYPES: list[AirQEntityDescription] = [
    ...
    AirQEntityDescription(
        key="clo2",
        REDACTED_VALUE"chlorine_dioxide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="cs2",
        REDACTED_VALUE"carbon_disulfide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="h2s",
        REDACTED_VALUE"hydrogen_sulfide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="hcl",
        REDACTED_VALUE"hydrochloric_acid",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="hcn",
        REDACTED_VALUE"hydrogen_cyanide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="hf",
        REDACTED_VALUE"hydrogen_fluoride",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="humidity_abs",
        REDACTED_VALUE"absolute_humidity",
    ...
    AirQEntityDescription(
        key="h2o2",
        REDACTED_VALUE"hydrogen_peroxide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="performance",
        REDACTED_VALUE"performance_index",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:head-check",
    ...
    AirQEntityDescription(
        key="ph3",
        REDACTED_VALUE"hydrogen_phosphide",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="sih4",
        REDACTED_VALUE"silicon_hydride",
        native_unit_of_measurement=CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="tvoc",
        REDACTED_VALUE"volatile_organic_compounds",
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_BILLION,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    AirQEntityDescription(
        key="tvoc_ionsc",
        REDACTED_VALUE"industrial_volatile_organic_compounds",
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_BILLION,
        state_class=SensorStateClass.MEASUREMENT,

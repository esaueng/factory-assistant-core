...
NUMBER_DESCRIPTIONS: tuple[NumberEntityDescription, ...] = (
    NumberEntityDescription(
        key="ph_target",
        REDACTED_VALUE"ph_target",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.PH,
    ),
    NumberEntityDescription(
        key="orp_target",
        REDACTED_VALUE"orp_target",
        entity_category=EntityCategory.CONFIG,
    ...
    NumberEntityDescription(
        key="cl_target",
        REDACTED_VALUE"cl_target",
        entity_category=EntityCategory.CONFIG,
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_MILLION,
    ),
    NumberEntityDescription(
        key="ofa_ph_lower",
        REDACTED_VALUE"ofa_ph_lower",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.PH,
    ),
    NumberEntityDescription(
        key="ofa_ph_upper",
        REDACTED_VALUE"ofa_ph_upper",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.PH,
    ),
    NumberEntityDescription(
        key="ofa_orp_lower",
        REDACTED_VALUE"ofa_orp_lower",
        entity_category=EntityCategory.CONFIG,
        device_class=NumberDeviceClass.VOLTAGE,
        native_unit_of_measurement=UnitOfElectricPotential.MILLIVOLT,
    ),
    ...
    NumberEntityDescription(
        key="ofa_cl_lower",
        REDACTED_VALUE"ofa_cl_lower",
        entity_category=EntityCategory.CONFIG,
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_MILLION,
    ),
    NumberEntityDescription(
        key="ofa_cl_upper",
        REDACTED_VALUE"ofa_cl_upper",
        entity_category=EntityCategory.CONFIG,
        native_unit_of_measurement=CONCENTRATION_PARTS_PER_MILLION,
    ),
    NumberEntityDescription(
        key="time_off_ph_dosing",
        REDACTED_VALUE"time_off_ph_dosing",
        entity_category=EntityCategory.CONFIG,
    ...
    NumberEntityDescription(
        ...
        REDACTED_VALUE"time_off_orp_dosing",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        device_class=NumberDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,
    ...
    NumberEntityDescription(
        ...
        REDACTED_VALUE"time_off_cl_dosing",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        device_class=NumberDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,
    ...
    NumberEntityDescription(
        ...
        REDACTED_VALUE"power_on_delay_timer",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        device_class=NumberDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,
    ...
    NumberEntityDescription(
        ...
        REDACTED_VALUE"flow_delay_timer",
        entity_category=EntityCategory.CONFIG,
        entity_registry_enabled_default=False,
        device_class=NumberDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,

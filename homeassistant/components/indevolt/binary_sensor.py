...
BINARY_SENSORS: Final = (
    ...
    IndevoltBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"meter_connected",
        on_value=1000,
        off_value=1001,
    ...
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(1,),
        REDACTED_VALUE"electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"main_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"battery_pack_1_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"battery_pack_2_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"battery_pack_3_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"battery_pack_4_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    IndevoltBinarySensorEntityDescription(
        ...
        generation=(2,),
        REDACTED_VALUE"battery_pack_5_electric_heating_state",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
)

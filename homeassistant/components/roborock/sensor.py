...
SENSOR_DESCRIPTIONS = [
    ...
    RoborockSensorDescription(
        ...
        device_class=SensorDeviceClass.DURATION,
        REDACTED_VALUE"cleaning_brush_time_left",
    ...
    RoborockSensorDescription(
        ...
        device_class=SensorDeviceClass.DURATION,
        REDACTED_VALUE"strainer_time_left",
    ...
    RoborockSensorDescription(
        ...
        REDACTED_VALUE"total_cleaning_count",
...
DYAD_SENSOR_DESCRIPTIONS: list[RoborockSensorDescriptionA01] = [
    ...
    RoborockSensorDescriptionA01(
        ...
        suggested_unit_of_measurement=UnitOfTime.HOURS,
        device_class=SensorDeviceClass.DURATION,
        REDACTED_VALUE"brush_remaining",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    RoborockSensorDescriptionA01(
        key="error",
...
ZEO_SENSOR_DESCRIPTIONS: list[RoborockSensorDescriptionA01] = [
    ...
    RoborockSensorDescriptionA01(
        ...
        REDACTED_VALUE"times_after_clean",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
]
...
Q10_B01_SENSOR_DESCRIPTIONS = [
    ...
    RoborockSensorDescriptionQ10(
        key="main_brush_life",
        REDACTED_VALUE"main_brush_life",

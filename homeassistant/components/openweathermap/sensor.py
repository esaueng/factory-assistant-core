...
WEATHER_SENSOR_TYPES: tuple[SensorEntityDescription, ...] = (
    SensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_WEATHER,
    ),
    SensorEntityDescription(
        key=ATTR_API_DEW_POINT,
        REDACTED_VALUEATTR_API_DEW_POINT,
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_FEELS_LIKE_TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_WIND_GUST,
        native_unit_of_measurement=UnitOfSpeed.METERS_PER_SECOND,
        device_class=SensorDeviceClass.WIND_SPEED,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    ...
    SensorEntityDescription(
        key=ATTR_API_CLOUDS,
        REDACTED_VALUEATTR_API_CLOUDS,
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=ATTR_API_RAIN,
        REDACTED_VALUEATTR_API_RAIN,
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_PRECIPITATION_KIND,
    ),
    SensorEntityDescription(
        key=ATTR_API_UV_INDEX,
        REDACTED_VALUEATTR_API_UV_INDEX,
        native_unit_of_measurement=UV_INDEX,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        key=ATTR_API_VISIBILITY_DISTANCE,
        REDACTED_VALUEATTR_API_VISIBILITY_DISTANCE,
    ...
    SensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_CONDITION,
    ),
    SensorEntityDescription(
        key=ATTR_API_WEATHER_CODE,
        REDACTED_VALUEATTR_API_WEATHER_CODE,
    ),
)

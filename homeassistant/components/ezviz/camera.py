...
class EzvizCamera(EzvizEntity, Camera):
    ...
    def perform_ptz(self, direction: str, speed: int) -> None:
        ...
        ir.async_create_issue(
            ...
            REDACTED_VALUE"service_depreciation_ptz",
        )
    ...
    def perform_sound_alarm(self, enable: int) -> None:
        ...
        ir.async_create_issue(
            ...
            is_persistent=True,
            severity=ir.IssueSeverity.WARNING,
            REDACTED_VALUE"service_depreciation_sound_alarm",
        )
    ...
    def perform_alarm_sound(self, level: int) -> None:
        ...
        ir.async_create_issue(
            ...
            is_persistent=True,
            severity=ir.IssueSeverity.WARNING,
            REDACTED_VALUE"service_deprecation_alarm_sound_level",
        )
        try:
    ...
    def perform_set_alarm_detection_sensibility(
        ...
        ir.async_create_issue(
            ...
            is_persistent=True,
            severity=ir.IssueSeverity.WARNING,
            REDACTED_VALUE"service_depreciation_detection_sensibility",
        )

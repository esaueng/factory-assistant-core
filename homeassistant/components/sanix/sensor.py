...
SENSOR_TYPES: tuple[SanixSensorEntityDescription, ...] = (
    SanixSensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_BATTERY,
    ...
    SanixSensorEntityDescription(
        ...
        REDACTED_VALUEATTR_API_DISTANCE,

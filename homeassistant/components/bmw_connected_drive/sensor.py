...
SENSOR_TYPES: list[BMWSensorEntityDescription] = [
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"ac_current_limit",
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"charging_start_time",
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"charging_end_time",
        device_class=SensorDeviceClass.TIMESTAMP,
        is_available=lambda v: v.is_lsc_enabled and v.has_electric_drivetrain,
    ),
    BMWSensorEntityDescription(
        key="fuel_and_battery.charging_status",
        REDACTED_VALUE"charging_status",
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"charging_target",
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"remaining_battery_percent",
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"remaining_range_total",
        device_class=SensorDeviceClass.DISTANCE,
        native_unit_of_measurement=UnitOfLength.KILOMETERS,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"remaining_range_electric",
        device_class=SensorDeviceClass.DISTANCE,
        native_unit_of_measurement=UnitOfLength.KILOMETERS,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"remaining_range_fuel",
        device_class=SensorDeviceClass.DISTANCE,
        native_unit_of_measurement=UnitOfLength.KILOMETERS,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
    ...
    BMWSensorEntityDescription(
        ...
        REDACTED_VALUE"remaining_fuel_percent",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        is_available=lambda v: v.is_lsc_enabled and v.has_combustion_drivetrain,
    ...
    *[
        BMWSensorEntityDescription(
            ...
            REDACTED_VALUEf"{tire}_current_pressure",
    ...
    *[
        BMWSensorEntityDescription(
            ...
            REDACTED_VALUEf"{tire}_target_pressure",
            device_class=SensorDeviceClass.PRESSURE,
            native_unit_of_measurement=UnitOfPressure.KPA,
            suggested_unit_of_measurement=UnitOfPressure.BAR,
            state_class=SensorStateClass.MEASUREMENT,

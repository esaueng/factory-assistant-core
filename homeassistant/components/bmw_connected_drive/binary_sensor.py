...
SENSOR_TYPES: tuple[BMWBinarySensorEntityDescription, ...] = (
    ...
    BMWBinarySensorEntityDescription(
        key="door_lock_state",
        REDACTED_VALUE"door_lock_state",
    ...
    BMWBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"condition_based_services",
    ...
    BMWBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"check_control_messages",
        device_class=BinarySensorDeviceClass.PROBLEM,
        # device class problem: On means problem detected, Off means no problem
    ...
    BMWBinarySensorEntityDescription(
        ...
        REDACTED_VALUE"is_pre_entry_climatization_enabled",

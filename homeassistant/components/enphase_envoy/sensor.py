...
INVERTER_SENSORS = (
    ...
    EnvoyInverterSensorEntityDescription(
        ...
        REDACTED_VALUE"last_report_duration",
    ...
    EnvoyInverterSensorEntityDescription(
        ...
        REDACTED_VALUELAST_REPORTED_KEY,
...
PRODUCTION_SENSORS = (
    EnvoyProductionSensorEntityDescription(
        key="production",
        REDACTED_VALUE"current_power_production",
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.POWER,
    ...
    EnvoyProductionSensorEntityDescription(
        ...
        REDACTED_VALUE"seven_days_production",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
...
PRODUCTION_PHASE_SENSORS = {
    (on_phase := PHASENAMES[phase]): [
        replace(
            ...
            REDACTED_VALUEf"{sensor.translation_key}_phase",
            entity_registry_enabled_default=False,
            on_phase=on_phase,
...
CONSUMPTION_SENSORS = (
    EnvoyConsumptionSensorEntityDescription(
        key="consumption",
        REDACTED_VALUE"current_power_consumption",
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.POWER,
        suggested_unit_of_measurement=UnitOfPower.KILO_WATT,
    ...
    EnvoyConsumptionSensorEntityDescription(
        ...
        REDACTED_VALUE"seven_days_consumption",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        suggested_display_precision=1,
    ...
    EnvoyConsumptionSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_consumption",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.MEGA_WATT_HOUR,
...
NET_CONSUMPTION_SENSORS = (
    EnvoyConsumptionSensorEntityDescription(
        ...
        REDACTED_VALUE"balanced_net_consumption",
        entity_registry_enabled_default=False,
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.POWER,
    ...
    EnvoyConsumptionSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_balanced_net_consumption",
        entity_registry_enabled_default=False,
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL,
        device_class=SensorDeviceClass.ENERGY,
...
CT_NET_CONSUMPTION_SENSORS = (
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_net_consumption",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.MEGA_WATT_HOUR,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_net_production",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.MEGA_WATT_HOUR,
    ...
    EnvoyCTSensorEntityDescription(
        key="net_consumption",
        REDACTED_VALUE"net_consumption",
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.POWER,
        suggested_unit_of_measurement=UnitOfPower.KILO_WATT,
    ...
    EnvoyCTSensorEntityDescription(
        key="frequency",
        REDACTED_VALUE"net_ct_frequency",
        native_unit_of_measurement=UnitOfFrequency.HERTZ,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.FREQUENCY,
        suggested_display_precision=1,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"net_ct_powerfactor",
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"net_ct_metering_status",
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"net_ct_status_flags",
        state_class=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
...
CT_PRODUCTION_SENSORS = (
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_frequency",
        native_unit_of_measurement=UnitOfFrequency.HERTZ,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.FREQUENCY,
        suggested_display_precision=1,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_voltage",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.VOLTAGE,
        suggested_unit_of_measurement=UnitOfElectricPotential.VOLT,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_current",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.CURRENT,
        suggested_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_powerfactor",
        device_class=SensorDeviceClass.POWER_FACTOR,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_registry_enabled_default=False,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_metering_status",
        device_class=SensorDeviceClass.ENUM,
        options=list(CtMeterStatus),
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"production_ct_status_flags",
        state_class=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda ct: 0 if ct.status_flags is None else len(ct.status_flags),
...
CT_STORAGE_SENSORS = (
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_battery_discharged",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.MEGA_WATT_HOUR,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"lifetime_battery_charged",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        state_class=SensorStateClass.TOTAL_INCREASING,
        device_class=SensorDeviceClass.ENERGY,
        suggested_unit_of_measurement=UnitOfEnergy.MEGA_WATT_HOUR,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"battery_discharge",
        native_unit_of_measurement=UnitOfPower.WATT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.POWER,
        suggested_unit_of_measurement=UnitOfPower.KILO_WATT,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"storage_ct_frequency",
        native_unit_of_measurement=UnitOfFrequency.HERTZ,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.FREQUENCY,
        suggested_display_precision=1,
    ...
    EnvoyCTSensorEntityDescription(
        key="storage_voltage",
        REDACTED_VALUE"storage_ct_voltage",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.VOLTAGE,
        suggested_unit_of_measurement=UnitOfElectricPotential.VOLT,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"storage_ct_current",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
        device_class=SensorDeviceClass.CURRENT,
        suggested_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"storage_ct_powerfactor",
        device_class=SensorDeviceClass.POWER_FACTOR,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_registry_enabled_default=False,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"storage_ct_metering_status",
        device_class=SensorDeviceClass.ENUM,
        options=list(CtMeterStatus),
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ...
    EnvoyCTSensorEntityDescription(
        ...
        REDACTED_VALUE"storage_ct_status_flags",
        state_class=None,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda ct: 0 if ct.status_flags is None else len(ct.status_flags),
...
ACB_BATTERY_POWER_SENSORS = (
    ...
    EnvoyAcbBatterySensorEntityDescription(
        ...
        REDACTED_VALUE"acb_battery_state",
        device_class=SensorDeviceClass.ENUM,
...
ACB_BATTERY_ENERGY_SENSORS = (
    EnvoyAcbBatterySensorEntityDescription(
        ...
        REDACTED_VALUE"acb_available_energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
...
AGGREGATE_BATTERY_SENSORS = (
    ...
    EnvoyAggregateBatterySensorEntityDescription(
        ...
        REDACTED_VALUE"aggregated_available_energy",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY_STORAGE,
        value_fn=attrgetter("available_energy"),
    ),
    EnvoyAggregateBatterySensorEntityDescription(
        ...
        REDACTED_VALUE"aggregated_max_capacity",
        native_unit_of_measurement=UnitOfEnergy.WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY_STORAGE,
        value_fn=attrgetter("max_available_capacity"),
    ),

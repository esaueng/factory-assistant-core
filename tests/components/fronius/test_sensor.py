...
async def test_symo_meter(hass, aioclient_mock):
    ...
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 228.6)
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 228.6)
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 231)
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 395.9
    )
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 398
    )
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 398
    )
...
async def test_gen24(hass, aioclient_mock):
    ...
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 235.9)
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 408.7
    )
    ...
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 236.1)
    assert_state(
        "sensor.energy_reactive_ac_produced_fronius_meter_0_http_fronius", 1989125.0
    )
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 236.9)
    assert_state("sensor.power_factor_phase_1_fronius_meter_0_http_fronius", 0.441)
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 409.6
    )
    ...
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 409.4
    )
...
async def test_gen24_storage(hass, aioclient_mock):
    ...
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 229.4)
    assert_state("sensor.power_real_phase_2_fronius_meter_0_http_fronius", 150.0)
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 394.3
    )
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 225.6)
    assert_state(
    ...
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 396.0
    )
    assert_state(
        "sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 393.0
    )
    ...
    assert_state("sensor.REDACTED_VALUE_fronius_meter_0_http_fronius", 228.3)

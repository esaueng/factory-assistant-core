...
async def test_symo_meter(
    ...
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE", 228.6)
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE", 228.6)
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE", 231)
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE_2", 395.9)
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE_3", 398)
    assert_state("sensor.smart_meter_63a_REDACTED_VALUE_1", 398)
...
async def test_gen24(
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 235.9)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_2", 408.7)
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 236.1)
    assert_state("sensor.smart_meter_ts_65a_3_reactive_energy_produced", 1989125.0)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 236.9)
    assert_state("sensor.smart_meter_ts_65a_3_power_factor_phase_1", 0.441)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_3", 409.6)
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_1", 409.4)
...
async def test_gen24_storage(
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 229.4)
    assert_state("sensor.smart_meter_ts_65a_3_real_power_phase_2", 150.0)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_1", 394.3)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 225.6)
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_2", 396.0)
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE_3", 393.0)
    ...
    assert_state("sensor.smart_meter_ts_65a_3_REDACTED_VALUE", 228.3)

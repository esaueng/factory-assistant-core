...
async def test_tai8570_sensors(
    ...
    mock_device[ATTR_INJECT_READS]["/REDACTED_VALUE"] = [
        OWServerReturnError(2, "legacy", "/12.111111111111/REDACTED_VALUE")
    ]
    mock_device[ATTR_INJECT_READS]["/REDACTED_VALUE"] = [
        OWServerReturnError(2, "legacy", "/12.111111111111/REDACTED_VALUE")
    ]
    ...
    assert "unreachable sensor /12.111111111111/REDACTED_VALUE" in caplog.text

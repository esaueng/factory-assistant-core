...
MOCK_OWPROXY_DEVICES = {
    ...
    "12.111111111111": {
        ATTR_INJECT_READS: {
            ...
            "/REDACTED_VALUE": [b"    25.123", b"    25.123"],
            "/REDACTED_VALUE": [b"  1025.123", b"  1025.123"],
            "/PIO.A": [b"    1"],
            "/PIO.B": [b"    0"],
            "/latch.A": [b"    1"],
            "/latch.B": [b"    0"],
    ...
    "26.111111111111": {
        ATTR_INJECT_READS: {
            ...
            "/temperature": [b"    25.123"],
            "/humidity": [b"    72.7563"],
            "/REDACTED_VALUE": [b"    73.7563"],
            "/HIH4000/humidity": [b"    74.7563"],
            "/REDACTED_VALUE": [b"    75.7563"],
            "/REDACTED_VALUE": [OWServerProtocolError],

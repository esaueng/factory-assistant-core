...
async def test_adam_restore_state_climate(
    ...
    data["REDACTED_VALUE"]["selec_regulation_mode"] = "off"
...
async def test_adam_3_climate_entity_attributes(
    ...
    data = mock_smile_adam_heat_cool.async_update.return_value
    data["REDACTED_VALUE"]["select_regulation_mode"] = "heating"
    ...
    data["REDACTED_VALUE"]["binary_sensors"]["cooling_state"] = False
    data["REDACTED_VALUE"]["binary_sensors"]["heating_state"] = True
    with patch(HA_PLUGWISE_SMILE_ASYNC_UPDATE, return_value=data):
        freezer.tick(timedelta(minutes=1))
        async_fire_time_changed(hass)
        await hass.async_block_till_done()
    ...
    data = mock_smile_adam_heat_cool.async_update.return_value
    data["REDACTED_VALUE"]["select_regulation_mode"] = "cooling"
    ...
    data["REDACTED_VALUE"]["binary_sensors"]["cooling_state"] = True
    data["REDACTED_VALUE"]["binary_sensors"]["heating_state"] = False
    with patch(HA_PLUGWISE_SMILE_ASYNC_UPDATE, return_value=data):
        freezer.tick(timedelta(minutes=1))
        async_fire_time_changed(hass)
        await hass.async_block_till_done()
    ...
    data = mock_smile_adam_heat_cool.async_update.return_value
    data["REDACTED_VALUE"]["select_regulation_mode"] = "off"
    data["f2bf9048bef64cc5b6d5110154e33c81"]["climate_mode"] = "off"

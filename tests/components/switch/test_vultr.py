...
class TestVultrSwitchSetup(unittest.TestCase):
    ...
    def test_switch(self, mock):
        ...
        mock.get(
            'https://api.vultr.com/v1/account/info?api_key=REDACTED_VALUE',
            text=load_fixture('vultr_account_info.json'))

        mock.get(
            'https://api.vultr.com/v1/server/list?api_key=REDACTED_VALUE',
    ...
    def test_turn_on(self, mock):
        ...
        mock.post(
            'https://api.vultr.com/v1/server/start?api_key=REDACTED_VALUE')
    ...
    def test_turn_off(self, mock):
        ...
        mock.post(
            'https://api.vultr.com/v1/server/halt?api_key=REDACTED_VALUE')

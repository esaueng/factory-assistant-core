...
_MOCK_API_DATA = {
    ...
    "REDACTED_VALUE": ("activities-caloriesBMR", "1900"),
    ...
    "REDACTED_VALUE": ("activities-minutesSedentary", 18),
    ...
    "REDACTED_VALUE": ("sleep-awakeningsCount", "7"),
    "sleep/efficiency": ("sleep-efficiency", "80"),
    "REDACTED_VALUE": ("sleep-minutesAfterWakeup", "17"),
    "sleep/minutesAsleep": ("sleep-minutesAsleep", "360"),
    "REDACTED_VALUE": ("sleep-minutesAwake", "35"),
    "REDACTED_VALUE": ("sleep-minutesToFallAsleep", "35"),
    ...
    "REDACTED_VALUE": ("foods-log-caloriesIn", "1600"),
}
